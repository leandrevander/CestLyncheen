...
public class GlowStickDetector : MonoBehaviour
{
	...
	private void OnTriggerStay2D(Collider2D other)
	{
		if (other.CompareTag("Ennemi"))
		{
			...
			Debug.DrawRay(player.transform.position, direction * distance, Color.blue);
			...
			if (hit.collider !=null && hit.collider == other)
			{
				...
				enemyHealth.IsHitByGlowStick = true;
			...
			{
				enemyHealth                  = cibleZombie.GetComponent<EnemyHealthManagement>();
				enemyHealth.IsHitByGlowStick = false;
